...
describe "Blacklight::Configuration" do
  ...
  describe "add_index_field" do
    ...
    it "takes IndexField param" do
      @config.add_index_field("title_tsim", Blacklight::Configuration::IndexField.new(:field => "title_tsim", :label => "Title"))
    ...
    it "creates default label from titleized field" do
      ...
      expect(@config.index_fields["title_tsim"].label).to eq "Title Display"
    end
  ...
  describe "add_show_field" do
    ...
    it "takes ShowField argument" do
      @config.add_show_field("title_tsim", Blacklight::Configuration::ShowField.new(:field => "title_tsim", :label => "Title"))
  ...
  describe "add_sort_field" do
    ...
    it "takes a SortField object" do
      @config.add_sort_field(Blacklight::Configuration::SortField.new(:label => "relevance", :sort => "score desc, pub_date_si desc, title_si asc"
))     
      expect(@config.sort_fields.values.find{|f| f.label == "relevance"}).to_not be_nil
    end
